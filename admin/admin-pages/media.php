                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-3">
                                                <form action="/admin/media/update/" method="post" class="form-horizontal">
                                                    ...
                                                    <!--br>
                                                    <button type="submit" class="btn btn-danger btn-block upload-button dirtyOK">Crop Image</button>
                                                    <br>
                                                    <button type="submit" class="btn btn-danger btn-block upload-button dirtyOK">Resize Image</button-->
                                                </form>
                                                <br>
                                            </div>
                                        </div>
