...
<html lang="en">
    <head>
        ...
        <!-- Custom CSS -->
        <link href="/admin/css/autocms.css?v=<?=VERSION?>" rel="stylesheet">
        <!-- Custom Fonts -->
        ...
        <link href="//cdnjs.cloudflare.com/ajax/libs/summernote/0.8.2/summernote.css" rel="stylesheet" type="text/css">
