...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-4 hidden-xs" style="text-align: center"><h4>Options</h4></div>
    </div>
    <hr>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-4 col-xs-12">
                ...
                <div class="btn-group btn-group-justified">
                    <a href="#" class="btn btn-danger" title="Delete Post"><i class="fa fa-trash"></i></a>
                    <?php if(isset($blog['published'])) { ?>
                        <a href="#" class="btn btn-warning" title="Unpublish Post"><i class="fa fa-pause"></i></a>
                    <?php } else { ?>
                        <a href="#" class="btn btn-warning" title="Publish Post"><i class="fa fa-play"></i></a>
                    <?php } ?>
                    <a href="/" class="btn btn-success" title="View Post" target="_blank"><i class="fa fa-eye"></i></a>
